"""
Django settings for zamartus project.
...
SECRET_KEY = 'django-insecure-*s3@epzk5e&$^4lj1yvenl*@)wwggn*wh89gtvt^=6l-_r$)-m'
...
WSGI_APPLICATION = 'zamartus.wsgi.application'
